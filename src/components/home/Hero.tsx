...
export function Hero() {
  return (
    <section className="relative min-h-[520px] overflow-hidden border-b border-border sm:min-h-[580px] lg:min-h-[640px]">
      ...
      <div className="relative mx-auto flex min-h-[520px] max-w-4xl flex-col items-center justify-center px-6 py-16 text-center text-white sm:min-h-[580px] lg:min-h-[640px] lg:px-8 lg:py-20">
        <div className="animate-fade-up">
          <p className="section-label mb-4 !text-white/75">Land & Development</p>
          <h1 className="font-display text-5xl font-medium leading-[1.08] tracking-tight sm:text-6xl lg:text-7xl">
            Dare to Dream.
          </h1>
          <p className="mt-4 font-display text-2xl font-medium leading-snug sm:text-3xl lg:text-4xl">
          ...
          <div className="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row">
            ...
            <Button href="/contact" variant="secondary" className="!border-white/35 !bg-white/10 !text-white hover:!bg-white/15">
              Talk to an Expert
            </Button>
          </div>
        </div>
