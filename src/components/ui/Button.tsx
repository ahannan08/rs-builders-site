...
const variants = {
  primary:
    "bg-accent text-accent-contrast font-semibold hover:bg-accent-hover shadow-sm shadow-accent/20",
  secondary:
    "bg-surface text-primary border border-border hover:border-accent/40 hover:bg-elevated",
